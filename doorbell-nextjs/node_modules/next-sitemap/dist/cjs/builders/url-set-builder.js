            ...
            return __generator(this, function (_z) {
                switch (_z.label) {
                    case 0:
                        ...
                        if (!((_j = this.config) === null || _j === void 0 ? void 0 : _j.exclude)) return [3 /*break*/, 3];
                        if (!(typeof this.config.exclude === 'function')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.config.exclude()];
                    case 1:
                        asyncExcludes = _z.sent();
                        urlSet = (0, array_js_1.removeIfMatchPattern)(urlSet, asyncExcludes);
                        return [3 /*break*/, 3];
                    case 2:
                        urlSet = (0, array_js_1.removeIfMatchPattern)(urlSet, (_k = this.config) === null || _k === void 0 ? void 0 : _k.exclude);
                        _z.label = 3;
                    case 3:
                        urlSet = __spreadArray([], __read(new Set(urlSet)), false);
                        notFoundRoutes = ((_o = (_m = (_l = this.manifest) === null || _l === void 0 ? void 0 : _l.preRender) === null || _m === void 0 ? void 0 : _m.notFoundRoutes) !== null && _o !== void 0 ? _o : []);
                        ...
                        _z.label = 4;
                    case 4:
                        _z.trys.push([4, 9, 10, 11]);
                        urlSet_1 = __values(urlSet), urlSet_1_1 = urlSet_1.next();
                        _z.label = 5;
                    case 5:
                        if (!!urlSet_1_1.done) return [3 /*break*/, 8];
                        url = urlSet_1_1.value;
                        return [4 /*yield*/, ((_q = (_p = this.config) === null || _p === void 0 ? void 0 : _p.transform) === null || _q === void 0 ? void 0 : _q.call(_p, this.config, url))];
                    case 6:
                        sitemapField = _z.sent();
                        ...
                        if ((_r = this.config) === null || _r === void 0 ? void 0 : _r.additionalPaths) {
                    ...
                    case 10:
                        try {
                            if (urlSet_1_1 && !urlSet_1_1.done && (_x = urlSet_1["return"])) _x.call(urlSet_1);
                        }
                        finally { if (e_1) throw e_1.error; }
                        return [7 /*endfinally*/];
                    case 11:
                        if (!((_s = this.config) === null || _s === void 0 ? void 0 : _s.additionalPaths)) return [3 /*break*/, 13];
                        return [4 /*yield*/, ((_t = this.config) === null || _t === void 0 ? void 0 : _t.additionalPaths(__assign(__assign({}, this.config), { transform: (_v = (_u = this.config) === null || _u === void 0 ? void 0 : _u.transform) !== null && _v !== void 0 ? _v : defaults_js_1.defaultSitemapTransformer })))];
                    case 12:
                        additions = (_w = (_z.sent())) !== null && _w !== void 0 ? _w : [];
                        ...
                        try {
                            ...
                            try {
                                if (additions_1_1 && !additions_1_1.done && (_y = additions_1["return"])) _y.call(additions_1);
                            }
