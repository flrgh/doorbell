...
describe('UrlSetBuilder', function () {
    ...
    test('createUrlSet: With async exclusion', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sleep, builder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    builder = new url_set_builder_js_1.UrlSetBuilder(__assign(__assign({}, config_js_1.sampleConfig), { exclude: function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sleep(10)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/, ['/', '/page-0', '/page-2']];
                                }
                            });
