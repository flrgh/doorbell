...
describe('UrlSetBuilder', function () {
    test('normalizeSitemapField: No sitemap field trailingSlash provided => Use config.trailingSlash', function () { return __awaiter(void 0, void 0, void 0, function () {
        var builder, normalizedField;
        return __generator(this, function (_a) {
            ...
            normalizedField = builder.normalizeSitemapField({
                changefreq: 'daily',
    ...
    test('normalizeSitemapField: Sitemap field trailingSlash provided => Use field.trailingSlash', function () { return __awaiter(void 0, void 0, void 0, function () {
        var builder, normalizedField;
        return __generator(this, function (_a) {
            builder = new url_set_builder_js_1.UrlSetBuilder(__assign(__assign({}, config_js_1.sampleConfig), { trailingSlash: false }), manifest_js_1.sampleManifest);
            normalizedField = builder.normalizeSitemapField({
